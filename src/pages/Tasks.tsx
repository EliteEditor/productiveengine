    ...
    <div className="flex flex-col min-h-screen">
      ...
      <Dialog open={isAddTaskOpen} onOpenChange={setIsAddTaskOpen}>
        <DialogContent className="sm:max-w-[425px] dark:bg-gray-800 dark:border-gray-700">
          <DialogHeader>
            <DialogTitle className="dark:text-gray-100">Add New Task</DialogTitle>
            <DialogDescription className="dark:text-gray-300">Create a new task to track your progress</DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              <Label htmlFor="task-title" className="dark:text-gray-200">Task Title</Label>
              <Input 
                id="task-title" 
                value={taskTitle} 
            ...
            <div className="grid gap-2">
              <Label htmlFor="task-category" className="dark:text-gray-200">Category</Label>
              <Select value={taskCategory} onValueChange={(value) => setTaskCategory(value as TaskCategory)}>
                <SelectTrigger id="task-category" className="dark:bg-gray-700 dark:border-gray-600 dark:text-gray-100">
            ...
            <div className="grid gap-2">
              <Label htmlFor="task-description" className="dark:text-gray-200">Description (Optional)</Label>
              <Input 
                id="task-description" 
            ...
            <div className="grid gap-2">
              <div className="flex justify-between">
                <Label className="dark:text-gray-200">Due Date (Optional)</Label>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setIsAddTaskOpen(false)} className="dark:border-gray-600 dark:text-gray-200">Cancel</Button>
