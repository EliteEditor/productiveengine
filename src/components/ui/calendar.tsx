    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 dark:bg-gray-800 dark:border-gray-600 dark:hover:bg-gray-700 dark:text-white"
        ),
        ...
        day: cn(
          ...
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 dark:hover:bg-gray-700 dark:text-gray-300"
        ),
        ...
        day_today: "bg-accent text-accent-foreground dark:bg-blue-500/20 dark:text-blue-200",
        day_outside:
